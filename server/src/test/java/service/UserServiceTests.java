...
public class UserServiceTests {
    ...
    public void loginBadRequest() throws DataAccessException {
        ...
        Assertions.assertThrows(DataAccessException.class, () -> userService.login(noUsername), "Login with null username should throw an exception");

        LoginRequest noPassword = new LoginRequest(existingUser.username(), null);
        Assertions.assertThrows(DataAccessException.class, () -> userService.login(noPassword), "Login with null password should throw an exception");
    }
